...
--InsertDoctor Proc
go
create or alter procedure SP_InsertDoctor @EmpType char(1), @Fname varchar(50), @Lname varchar(50),         
...
go
exec SP_InsertDoctor @EmpType = 'D', @Fname = 'Ahmed',@Lname = 'Talaat',@DOB = '1980-05-15', @Phone = '04112793478',
@Gender = 'M', @Salary = 12700, @Street = '123 Elm St',@DeptID = 106, @Speciality = 'Dermatology'

--------------------------------------------------------------------------------------------------
--InsertNurse Proc
go
create or alter procedure SP_InsertNurse @EmpType char(1), @Fname varchar(50), @Lname varchar(50),         
...
go
exec SP_InsertNurse @EmpType = 'N',@Fname = 'Nour',@Lname = 'Adel',@DOB = '1980-05-15', @Phone = '01142793478', @Gender = 'F',
 @Salary = 6660, @Street = '123 Elm St', @DeptID = 106

--------------------------------------------------------------------------------------------------
--InsertReceptionist Proc
go
create or alter procedure SP_InsertReceptionist @EmpType char(1), @Fname varchar(50), @Lname varchar(50),         
    @DOB date, @Phone varchar(15), @Gender char(1), @Salary money, @Street varchar(100), 
    @City varchar(50) = 'Cairo', @State varchar(50) = 'Egypt', @DeptID int
as
begin
...
go
exec SP_InsertReceptionist @EmpType = 'R', @Fname = 'Radwa',@Lname = 'Mohamed',@DOB = '1980-05-15', @Phone = '01342793878', @Gender = 'F',
...
go
create or alter proc SP_InsertPrescription @description varchar(max), @pid int
as
begin
  begin try
    if exists (select 1 from patient where id = @pid)
    begin
      insert into Prescription (description, pid)
      values (@description, @pid)
...
go
exec SP_insertPrescription @description = 'Take Panadol 400mg every 4-6 hours', @pid = 11
go
exec SP_insertPrescription @description = 'Take 500mg Amoxicillin every 8 hours', @pid = 12
...
go
exec SP_InsertBill @Amount = 5000, @PID = 12, @RID = 16, @Date = '2024-12-28 13:00:00'
...
go
create or alter procedure SP_InsertExaminePatient @DID int,@InPID int, @date date
as 
begin
	Begin try
...
go
create or alter procedure SP_InsertGivenDrug @Dosage varchar(30),@Date Date,@DragCode int,@Inpid int,@NID int
as 
begin
   Begin try
...
go
exec SP_InsertGivenDrug @Dosage = '500mg', @Date = '2024-12-27 21:00:00', @DragCode = 127, @Inpid = 12, @NID = 15
