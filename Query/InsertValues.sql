...
values 
	('2024-12-29 5:30:00', 'Follow-up check', 3, 1, 12, 'Done'),
	('2024-12-27 10:30:00', 'Routine visit', 1, 2, 12, 'Done'),
	('2024-12-30 4:00:00', null, 2, 3, 11, 'Done'),
	(getdate(), null, 3, 4, 13, 'Done'),
	('2024-12-28 7:00:00', null, 5, 5, 11, 'Done'),
	('2024-12-31 5:00:00', null, 4, 6, 13, 'Done'),
	(getdate(), null, 2, 7, 11, 'Done'),
	(getdate(), 'Emergency Appointment', 1, 8, 13, 'Done'),
	(getdate(), 'Emergency Appointment', 4, 9, 11, 'Done'),
...
values 
	(1, 6, '2024-12-31 7:00:00'), (2, 10, '2024-12-31 4:00:00')
...
----------------------------------------------------------------------------------------------------
--Insert records into PrescriptionDoctor table
...
values
  ...
  --(50000, 10, 12, dateadd(day, 7, '2024-12-30 8:00:00'))
